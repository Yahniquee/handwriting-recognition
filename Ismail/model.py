...
class Model:
    ...
    def __init__(self):
        ...
        with tf.control_dependencies(self.update_ops):
            self.optimizer = tf.train.RMSPropOptimizer(self.learning_rate).minimize(self.loss)  #training 
           #self.optimizer = tf.train.GradientDescentOptimizer(self.learning_rate).minimize(self.loss)  #training 
           #self.optimizer = tf.train.MomentumOptimizer(self.learning_rate).minimize(self.loss,global_step=batch)  #training  -Does not work
